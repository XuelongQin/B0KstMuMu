...
//    RooArgSet *param = EffPdf->getVariables();
    ...
    if (effCHist!=0){
       cout << "correctly tagged efficiency is existed" << endl; 
   }
...
//    c1.SaveAs("effc.png") ;  
    ...
    RooArgList varslist (*ctK,*ctL,*phi);
    RooArgSet vars (varslist);
   ...
   cout<<"Efficiency conf: "<<effCHist->GetTitle()<<endl;
...
int main(int argc, char **argv) {
	...
	cout << "\n./Moment\tParatype\tSampletype\t" << endl;
